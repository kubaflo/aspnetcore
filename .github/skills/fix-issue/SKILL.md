...
Phase 5: Finalize      → ⚠️ MANDATORY push, create PR, post comment — NEVER skip
```
...
- ❌ **Never skip Phase 5 — PR creation and summary comment are MANDATORY**
...
- [ ] **Step 3: Post AI Summary** — Post summary comment on the PR
...
## Summary
Fixes #{IssueNumber} — {title}
{description of changes, root cause, multi-model exploration results}
EOF
...
3. An AI summary comment is posted on the PR
